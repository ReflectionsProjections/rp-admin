...
export default function Auth() {
  ...
  localStorage.setItem(
    "jwt",
    "http://localhost:5173/home?eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJ1c2VyMTEwNjA5ODYzNzM1NDUyNzE1NzEzIiwiZGlzcGxheU5hbWUiOiJWYW5pIFJhbWVzaCIsImVtYWlsIjoidmFuaXIyQGlsbGlub2lzLmVkdSIsInJvbGVzIjpbIlVTRVIiLCJBRE1JTiJdLCJpYXQiOjE3NDMzNTEyNjMsImV4cCI6MTc0MzQzNzY2M30.PsF3hWPwuN18EYyTn4p0K-swa5tGcyGfkbCefASYIgM"
  );
